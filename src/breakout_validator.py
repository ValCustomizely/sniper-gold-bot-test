...
class BreakoutValidator:
    ...
    def _check_breakout_invalidation(self, current_price: float, thresholds: List[Dict[str, Any]]):
        ...
        if r1_value and s1_value and s1_value <= current_price <= r1_value:
            ...
            # Enregistrer l'échec pour les statistiques
            threshold_name = self.state_manager.current_state.get("seuil_en_cours")
            if threshold_name:
                self.state_manager.track_breakout_result(threshold_name, False)
